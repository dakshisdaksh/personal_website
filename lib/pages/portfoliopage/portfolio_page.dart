  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        } else if (constraints.maxWidth > 600 && constraints.maxWidth < 3000) {
...
Widget workShowCaseImages(
    double imageHeight, double imageWidth, String imageUrl, String projectname) {
  return Material(
    //color: Colors.white,
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Text(projectname, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ),
          ),
        )
      ],
